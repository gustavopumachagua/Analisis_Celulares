...
AMAZON_URL = "https://www.amazon.com/-/es/s?i=computers-intl-ship&bbn=16225007011&rh=n%3A16225007011%2Cn%3A13896617011%2Cn%3A565108&dc"
...
for i in range(1, PAGE_COUNT + 1):
    url_pagina = f"{AMAZON_URL}&page={i}&language=es&qid=1679021259&rnid=2528832011&ref=sr_pg_{i}"
    ...
    for producto in contenedores_productos:
        ...
        price_elem = producto.find('span', {'class': 'a-offscreen'})
